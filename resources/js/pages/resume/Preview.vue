                            ...
                            <ul>
                                ...
                                >
                                    <i
                                        class="fa-solid"
                                        :class="{
                                            'created fa-check': hasSoftSkills,
                                            'need-to-create fa-exclamation':
                                                !hasSoftSkills,
                                        }"
                                    ></i>
                    ...
                    <div class="col-12 col-lg-9">
                        <div class="preview-wrapper relative">
                            <div class="resume-preview">
                                ...
                                <Layout1
                                    v-if="hasProfileCreated && !isLoading"
                                />
                                <div
                                    v-else-if="!hasProfileCreated && !isLoading"
                                    class="no-resume-box"
                                >
                                    <h3 class="no-resume-text">
                                        {{
                                            $t(
                                                "resume.please_fill_basic_information"
                                            )
                                        }}
                                    </h3>
                                    <router-link
...
export default {
    ...
    methods: {
        ...
        ...mapActions("softSkill", { loadSoftSkills: "loadItems" }),
        ...
        async loadResume() {
            ...
            await this.loadUserProfile()
                ...
                .then(() => {
                    this.loadingText = this.$t("resume.loading_soft_skills");
                    return this.loadSoftSkills();
                })
                .finally(() => {
                    this.loadingText = "";
