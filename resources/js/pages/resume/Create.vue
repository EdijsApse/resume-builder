    ...
    <base-container>
        ...
        <template #default>
            <div class="container">
                <div class="row">
                    <div
                        class="col-12 col-lg-3 mobile-fixed-sidebar"
                        ref="sidebar"
                    >
                        <div class="left-sidebar">
                            <div
                                class="close-icon"
                                @click="
                                    $refs.sidebar.classList.remove('visible')
                                "
                            >
                            ...
                            <ul>
                                <li
                                    @click="activeComponent = 'Profile'"
                                    :class="{
                                        'selected-section':
                                            activeComponent === 'Profile',
                                        completed: hasProfileCreated,
                                    }"
                                >
                                ...
                                <li
                                    @click="activeComponent = 'Education'"
                                    :class="{
                                        'selected-section':
                                            activeComponent === 'Education',
                                        completed: hasEducations,
                                    }"
                                >
                                    <i class="fa-regular fa-square-check"></i>
                                ...
                                <li
                                    @click="activeComponent = 'Certificate'"
                                    :class="{
                                        'selected-section':
                                ...
                                <li
                                    @click="activeComponent = 'Language'"
                                    :class="{
                                        'selected-section':
                                ...
                                <li
                                    @click="activeComponent = 'Skill'"
                                    :class="{
                                        'selected-section':
                                            activeComponent === 'Skill',
                                        completed: hasSkills,
                                    }"
                                >
                                    <i class="fa-regular fa-square-check"></i>
                                ...
                                <li
                                    @click="activeComponent = 'SoftSkill'"
                                    :class="{
                                        'selected-section':
                                            activeComponent === 'SoftSkill',
                                        completed: hasSoftSkills,
                                    }"
                                >
                                    <i class="fa-regular fa-square-check"></i>
                                    <span>{{ $t("resume.soft_skills") }}</span>
                                </li>
                            </ul>
                            <button
                                class="btn btn-secondary mt-4 w-100"
                                @click="$router.push({ name: 'PreviewResume' })"
                            >
                                {{ $t("resume.preview_resume") }}
                            </button>
                            <div v-if="hasProfileCreated" class="mt-6">
                                <a
                                    :href="`${user.resume_link}?lang=${$i18n.locale}`"
                                    target="_BLANK"
                                    class="btn btn-primary"
                                    >{{ $t("resume.download_resume") }}</a
                                >
                            </div>
                        </div>
                    </div>
                ...
                <div
                    ...
                    @click="$refs.sidebar.classList.add('visible')"
                >
...
import SoftSkill from "@components/resume/SoftSkills.vue";
